...
This directory contains several `.parquet` files generated by the Step 2 pipeline 
(momentum portfolios, value portfolios, factor matrices, and signals). These files are intentionally kept in the same folder as the pipeline scripts 
because the dashboard and portfolio builder read them directly from this path.
